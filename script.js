const slides = [
  ...
  },
  {
    ...
    {
    section: 'Basics', visual: 'orbit', duration: 70,
  ...
  },
{
  ...
  {
    section: 'Astrometry', duration: 45,
    kicker: 'Doubt Break', title: 'Questions?',
    subtitle: ' ',
  ...
  }, 
  {
    ...
    body: `<ul>
              <li>If the orbit is nearly edge-on, the planet blocks a small fraction of starlight.</li>
              <li>The result is a periodic dip in brightness.</li>
              <li>This is one of the most productive detection methods.</li>
              <li>Unlike many other detection methods, transit photometry can directly measure planetary radius and can be applied to thousands of stars simultaneously.</li>
              </ul>`,
  ...
  {
    section: 'Transits', duration: 70,
    kicker: 'Transit depth', title: 'The dip tells us the planet radius',
    subtitle: "The dimming equals planet's area compared to star's area.",
    body: `<div class="equation">δ ≈ (R<sub>p</sub> / R<sub>★</sub>)²</div><ul><li>δ is transit depth.</li><li>R<sub>p</sub> is planet radius.</li><li>R<sub>★</sub> is stellar radius.</li></ul><div class="callout">A Jupiter-sized planet blocks much more light than an Earth-sized planet.</div>`,
    image: 'images/Transit 3D.png',
  ...
  {
    section: 'Transits', visual: 'transit2', duration: 65,
    kicker: 'Transit probability', title: 'Why Most Planets Don\'t Transit',
    subtitle: 'A transit is observed only when a planet\'s orbit is aligned.',
    body: `A transit is observed only when a planet's orbit is aligned so that it passes in front of its star as seen from Earth. Since planetary orbits can have many different orientations, only a small fraction of planets produce observable transits. <br> <div class="equation">P<sub>transit</sub> ≈ R<sub>★</sub> / a</div><ul><li>Close-in planets are more likely to transit.</li><li>Larger stars provide a larger target.</li><li>This introduces a strong detection bias toward short-period planets.</li></ul>`,
  ...
  {
    section: 'Transits', visual: 'transit2', duration: 60,
  ...
  {
    section: 'Transits',  duration: 60,
    kicker: 'Atmospheres', title: 'Transits can probe atmospheres',
    image: 'images/Trappist1.png',
    subtitle: 'During transit, some starlight filters through the planet atmosphere before reaching us.',
    body: `<ul><li>Transmission spectroscopy compares in-transit and out-of-transit spectra.</li><li>Absorption features act as chemical fingerprints, revealing molecules such as H₂O, CO₂, CH₄ and Na.</li><li>Secondary eclipses and phase curves can probe thermal emission and reflection.</li></ul>`,
  ...
  {
    section: 'Radial Velocity', duration: 55,
  ...
  },
  {
    ...
    kicker: 'Barycentric orbit', title: 'The Star Wobbles??',
    subtitle: 'Both objects orbit the common centre of mass, but the star’s orbit is much smaller.',
    body: `<div class="equation">M<sub>★</sub> r<sub>★</sub> = M<sub>p</sub> r<sub>p</sub></div><ul><li>Massive planets create larger stellar wobble.</li><li>Close-in planets complete more cycles quickly.</li><li>Edge-on systems produce the strongest radial velocity signal.</li></ul>`,
    notes: `Show the wobble visual. Point out that the star does not sit perfectly still; it moves around the barycentre.`
  },
  {
    section: 'Radial Velocity', duration: 70,
    image: 'images/rvtheory.png',
  ...
  {
    section: 'Radial Velocity', visual: 'rv', duration: 65,
    kicker: 'Inclination limit', title: 'Radial velocity gives M<sub>p</sub> sin(i)',
    subtitle: 'Because only line-of-sight motion is measured, the true mass depends on orbital inclination.',
    body: `<div class="equation">Measured mass ∝ M<sub>p</sub> sin(i)</div><ul><li>Edge-on orbit: sin(i) is near 1.</li><li>Face-on orbit: radial velocity is small or absent.</li><li>So RV often gives a minimum mass.</li></ul>`,
  ...
  {
    section: 'Radial Velocity', duration: 60,
    kicker: 'Precision enemies', title: 'Stars are noisy too',
    image: 'images/51P.png',
    subtitle: 'Stellar activity can shift or distort spectral lines even without planets.',
    body: `<div class="cards"><div class="card"><h3>Starspots</h3><p>Rotating spots change the apparent line profile.</p></div><div class="card"><h3>Oscillations</h3><p>Stellar surfaces vibrate and convect.</p></div><div class="card"><h3>Instrument drift</h3><p>Spectrographs need extreme stability (often calibrated with Iodine gas cells or Thorium-Argon lamps).</p></div><div class="card"><h3>Bisectors</h3><p>Line-shape diagnostics help separate activity from true motion.</p></div></div>`,
    notes: `Mention that modern RV is an instrumentation triumph. The velocities can be only metres per second or smaller, so calibration (using reference light sources) and stellar noise modelling matter a lot.`
  },
  {
    section: 'Radial Velocity', duration: 55,
    ...
    body: `<ul><li>Large planet mass increases the signal.</li><li>Short orbital period gives many cycles quickly.</li><li>Works best with sharp, stable stellar spectra (like G and K type stars).</li><li>Has successfully discovered around 1050 exoplanets to date.</li></ul>`,
    notes: `Tie back to 51 Pegasi b, which was the first confirmed exoplanet around a Sun-like star with a short 4.2-day orbit. The method was ideal for detecting a close-in giant planet. Today, around 1050 planets have been discovered this way.`
  },
  {
    section: 'Radial Velocity',
    duration: 55,
    image: 'images/TRV.png',
    kicker: 'Combining Methods',
    title: 'Transit + Radial Velocity',
    subtitle: 'Together, these methods provide both the size and mass of an exoplanet.',
    body: `<ul>
    <li>Transit photometry measures the planetary radius (R<sub>p</sub>) from the transit depth.</li>
    <li>Radial velocity measurements provide the planetary mass (M<sub>p</sub> sin i).</li>
    <li>For transiting planets, i ≈ 90°, so M<sub>p</sub> sin i ≈ M<sub>p</sub>.</li>
    <li>Combining mass and radius yields the planet's mean density, revealing whether it is rocky, gaseous or icy.</li>
    </ul>`,
    notes: `This is why transit and RV are often used together. Transit gives radius, RV gives mass. Combining both allows astronomers to determine density and infer planetary composition.`
  },
  {
  ...
  },
  {
    ...
    body: `<div class="table-wrap"><table><tr><th>Method</th><th>Best targets</th><th>Main output</th><th>Major bias</th><th>Discoveries</th></tr><tr><td>Transit</td><td>Close-in edge-on systems</td><td>Radius, period</td><td>Needs alignment</td><td>~4000</td></tr><tr><td>Radial velocity</td><td>Massive close-in planets</td><td>Minimum mass, period</td><td>Weak for face-on or tiny planets</td><td>~1050</td></tr><tr><td>Direct imaging</td><td>Young warm wide giants</td><td>Light, spectra, orbit arc</td><td>Contrast and separation</td><td>>200</td></tr><tr><td>Microlensing</td><td>Distant systems, planets at several AU</td><td>Mass ratio, event parameters</td><td>Usually one-time event</td><td>>60</td></tr><tr><td>Astrometry</td><td>Nearby stars, wide massive planets</td><td>Sky-plane orbit, true mass help</td><td>Requires long precision monitoring</td><td>19</td></tr><tr><td>Pulsar timing</td><td>Stable cosmic clocks</td><td>Timing residual orbit</td><td>Rare host systems</td><td>~50</td></tr></table></div>`,
    notes: `Read across one or two rows only, not the entire table. The purpose is to show the logic of biases. Highlight the discovery counts to show how Transit and RV dominate current statistics.`
  },
  {
    section: 'Combining Methods', duration: 55,
  ...
  {
    section: 'Combining Methods', duration: 60,
    kicker: 'Habitability', title: 'Habitability',
    image: 'images/Habzone.jpeg',
    subtitle: ' Right distance is step one. Here’s the rest.',
    body: `<ul>
              <li>Star & planet bulk: Stable G/K stars are preferred over flare-prone M-dwarfs. Planets must be 0.5–2× Earth-mass to retain volatiles without accumulating a thick gas envelope. A magnetic field and active core dynamo are essential to shield against stellar wind and atmospheric stripping.</li>
              <li>Atmospheric controls: Surface temperature hinges on greenhouse gases (CO₂, H₂O, CH₄), not just orbital distance. Pressure must exceed 6.1 mbar for liquid water, while cloud and ice-albedo feedbacks determine climate stability. These feedbacks can push a planet into Snowball or Runaway Greenhouse states.</li>
              <li>Habitable Zone reality: The inner edge marks runaway water loss; the outer edge marks CO₂ condensation collapse. The "just right" band only permits liquid water conditionally. Atmospheric composition and surface pressure are the final gatekeepers.</li>
              <li>Detection vs. characterization: Transits and radial velocity surveys find candidates. Only spectroscopy,analyzing atmospheric composition and biosignature gases, confirms true habitability. The zone gives coordinates, not answers.</li>
              </ul>`,
    notes: `Avoid overselling habitability. The habitable zone is a useful first filter, not a conclusion that life exists.`
  },
  {
    section: 'Combining Methods', duration: 45,
    kicker: 'Doubt Break', title: 'Questions?',
    subtitle: ' ',
    notes: `Use this final slide to invite questions. If there is extra time, ask the audience to design an observing strategy for a target star.`
  }, 
  {
    ...
    body: '<div class="cards"><div class="card"><h3>Space telescopes</h3><p>Stable above atmosphere; access to IR/UV windows; missions like JWST, PLATO, and future HabEx.</p></div><div class="card"><h3>Ground telescopes</h3><p>30+m apertures with extreme adaptive optics to resolve inner working angles.</p></div><div class="card"><h3>Detector sensitivity</h3><p>Lower read noise, higher QE, and larger formats enable photon-limited precision down to Earth-sized signals.</p></div><div class="card"><h3>Global networks</h3><p>Continuous all-sky coverage (e.g., NGTS, SPECULOOS) to catch transits and microlensing events in real time.</p></div></div>',
    notes: 'Highlight that each layer (space, ground, detectors, networks) addresses a different bottleneck—atmosphere, aperture, noise, and temporal coverage.'
  },
  {
    ...
    body: '<ul><li>Classify transit candidates and reject false positives (eclipsing binaries, stellar activity).</li><li>Detect weak periodic signals buried in correlated noise using recurrent or convolutional nets.</li><li>Analyze transmission spectra to classify exoplanet atmospheres and identify chemical compounds.</li><li>Model instrumental systematics and detrend light curves on the fly.</li></ul>',
    notes: 'ML is pattern recognition + prioritization. Stress that training labels, feature engineering, and validation are where the real astronomy happens. Neural networks are now even identifying potential habitable conditions from atmospheric spectra.'
  },
  {
    ...
    body: '<div class="table-wrap"><table><tr><th>Step</th><th>Process</th><th>What it does</th></tr><tr><td><b>01</b></td><td><b>Clean data</b></td><td>Remove systematics, cosmic rays, and detrend the light curve.</td></tr><tr><td><b>02</b></td><td><b>Search periodic dips</b></td><td>Apply BLS or transit-search algorithms to find recurring flux drops.</td></tr><tr><td><b>03</b></td><td><b>Extract features</b></td><td>Compute depth, duration, SNR, and shape metrics for each signal.</td></tr><tr><td><b>04</b></td><td><b>Classify candidates</b></td><td>Use ML (XGBoost, CNNs) to separate planets from false positives.</td></tr><tr><td><b>05</b></td><td><b>Human + telescope follow-up</b></td><td>Validate with ground-based photometry, RV, or spectroscopy.</td></tr></table></div>',
    notes: 'Explain that final confirmation still requires physical interpretation and often follow-up observations.'
  },
  {
    section: 'Future', duration: 60,
    image: "images/O2FP.png",
    ...
    body: '<ul><li>Transmission spectroscopy (JWST, Ariel) reveals molecular absorption—H₂O, CO₂, CH₄, and cloud decks.</li><li>Direct spectroscopy of young giants (ELTs, Roman) probes temperature structure and composition.</li><li>Future missions (HabEx, LUVOIR) aim for reflected-light spectra of nearby Earth-like planets.</li><li>Potential biosignatures (O₂ + CH₄ disequilibrium, phosphine) demand strict contextual vetting—no single molecule is a silver bullet.</li></ul>',
    notes: 'End with excitement + caution. Habitability is a multi-variable equation; spectra give data, but interpretation requires models and planetary context.'
  },
  {
  section: 'Activity', duration: 60,
  image: 'images/mult.gif',
  kicker: 'Audience check', title: 'Which method would you choose?',
  subtitle: 'Match the signal to the best detection method.',
  body: '<div class="cards"><div class="card"><h3>Periodic 1% brightness dip</h3><p><b>Transit</b> — planet crosses the stellar disk; depth gives radius, period gives orbit.</p></div><div class="card"><h3>Spectral lines shift every 4 days</h3><p><b>Radial velocity</b> — Doppler wobble; amplitude gives minimum mass (M sin i).</p></div><div class="card"><h3>Short spike during a one-time brightening</h3><p><b>Microlensing</b> — gravitational lensing; sensitive to wide orbits, but unrepeatable.</p></div><div class="card"><h3>Faint dot beside a bright young star</h3><p><b>Direct imaging</b> — high-contrast challenge; yields spectra of warm, wide-orbit giants.</p></div></div>',
  notes: 'Pause and ask the audience to call out their matches before revealing. Each card now includes the physical reason—so even if they guess wrong, they walk away with the core physics. Use this as a light but sticky knowledge check.'
  },
  {
  section: 'Activity', duration: 60,
  image: 'images/mult.gif',
  kicker: 'Decision tree', title: 'Think observable first',
  subtitle: 'Ask: what is actually changing in your data?',
  body: '<div class="cards" style="grid-template-columns: 1fr 1fr;"><div class="card"><h3> Brightness dips periodically</h3><p><b>Transit</b> — flux drops as planet crosses the star. <i>Constraint: needs near-perfect edge-on alignment.</i></p></div><div class="card"><h3>Spectral lines oscillate</h3><p><b>Radial velocity</b> — star wobbles due to planet\'s gravity. <i>Constraint: gives only minimum mass (M sin i).</i></p></div><div class="card"><h3>Star position wobbles on sky</h3><p><b>Astrometry</b> — measures true orbital motion. <i>Constraint: needs decades of sub‑milliarcsecond precision.</i></p></div><div class="card"><h3>Pulse arrival times shift</h3><p><b>Timing</b> — clock-like pulsar or eclipse variations. <i>Constraint: limited to rare, ultra-stable host systems.</i></p></div><div class="card"><h3>Background star briefly magnified</h3><p><b>Microlensing</b> — planet acts as a gravitational lens. <i>Constraint: unrepeatable one‑time event.</i></p></div><div class="card"><h3>Faint point source next to star</h3><p><b>Direct imaging</b> — captures planet\'s own light/spectra. <i>Constraint: extreme contrast ratio and inner working angle.</i></p></div></div>',
  notes: 'This is now a 2-column card grid. The intent is to build a mental reflex: data pattern → method → critical weakness. Pause here; let the audience read the constraint aloud. It sets up perfectly for "so how do we improve each?" in the next section.'
  },
  {
  section: 'Recap', duration: 60,
  kicker: 'Recap', title: 'Planets reveal themselves indirectly',
  subtitle: 'We don\'t see the planet-we measure its physical footprint. Technology turns tiny changes into discoveries.',
  body: '<div class="table-wrap"><table><tr><th>Physical effect</th><th>Observable signal</th><th>Detection methods</th><th>What we learn</th></tr><tr><td><b>Gravity</b></td><td>Stellar wobble (spectral shifts or sky motion)</td><td>Radial velocity, Astrometry</td><td>Planet mass (minimum or true) and orbital architecture</td></tr><tr><td><b>Geometry</b></td><td>Periodic stellar dimming</td><td>Transit photometry</td><td>Planet radius, orbital period, and atmospheric transmission access</td></tr><tr><td><b>Relativity</b></td><td>Magnification of a background star</td><td>Microlensing</td><td>Mass ratio; sensitive to wide-orbit planets (event is unrepeatable)</td></tr><tr><td><b>Atmosphere</b></td><td>Spectral absorption or emission lines</td><td>Transmission spectroscopy, Direct imaging</td><td>Chemical composition, temperature, cloud properties, and potential biosignatures</td></tr></table></div>',
  notes: 'This table ties every detection method back to a single underlying physical mechanism. Use it as a conceptual anchor: Gravity → mass, Geometry → radius, Relativity → wide orbits, Atmosphere → composition. The "technology" piece is now in the subtitle, acknowledging that sensitivity is the enabler.'
  },
  {
    section: 'Recap', visual: 'rv', duration: 60,
    kicker: 'Recap', title: 'Bias is built into every survey',
  ...
  {
    section: 'Recap', visual: 'transit2', duration: 55,
    kicker: 'Recap', title: 'Confirmation needs consistency',
...
function visualMarkup(type) {
  switch (type) {
    ...
    case 'transit2': return `<div class="transit2-system"><div class="transit2-star"><span class="transit2-planet planet-1"></span><span class="transit2-planet planet-2"></span></div><svg class="lightcurve" viewBox="0 0 520 250"><line class="graph-axis" x1="35" y1="210" x2="495" y2="210"/><line class="graph-axis" x1="35" y1="30" x2="35" y2="210"/><path class="graph-line2" d="M40 70 L175 70 C190 75, 205 132, 230 134 L302 134 C327 132, 342 75, 360 70 L495 70"/><text class="graph-label" x="210" y="235">time</text><text class="graph-label" x="7" y="38">flux</text></svg></div>`;
    ...
    case 'trv': return `<div class="transit-system"><div class="transit-star"><span class="transit-planet"></span></div><div class="spectrum"><span class="spectral-line"></span><span class="spectral-line"></span><span class="spectral-line"></span><span class="spectral-line"></span></div></div>`;
    ...
    case 'compass': return `<div class="method-compass">
        ...
        <div class="method-node">Exoplanet <br> Detection</div>
        </div>`;
...
function update() {
  ...
  notesContent.innerHTML = `<p>${slides[current].notes || 'Use this slide as a visual pause.'}</p>`;
  burst = 1;
}
